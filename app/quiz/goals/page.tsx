...
const GOAL_OPTIONS = [
  { value: "lose_weight" as const, icon: "⚖️", label: "减重", gradient: "orangeStatic", ariaLabel: "选择减重目标" },
  { value: "tone_muscle" as const, icon: "💪", label: "塑形", gradient: "purpleStatic", ariaLabel: "选择塑形目标" },
  { value: "build_muscle" as const, icon: "🏋️", label: "增肌", gradient: "red", ariaLabel: "选择增肌目标" },
  { value: "stay_healthy" as const, icon: "❤️", label: "保持健康", gradient: "greenStatic", ariaLabel: "选择保持健康目标" },
]
